...
def step_impl(context):
    context.credit_card_entry_page = CreditCardEntryPage(context.browser, context.config)
...
def step_impl(context, expected_response, expected_reason):
    context.credit_card_response_page = CreditCardResponsePage(context.browser, context.config)
